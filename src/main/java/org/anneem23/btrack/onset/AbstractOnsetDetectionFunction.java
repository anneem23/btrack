package org.anneem23.btrack.onset;


import be.tarsos.dsp.util.fft.HammingWindow;
import org.anneem23.btrack.fft.Complex;
import org.anneem23.btrack.fft.FFT;
...
abstract class AbstractOnsetDetectionFunction implements OnsetDetectionFunction {
    ...
    public double calculateOnsetDetectionFunctionSample(double[] buffer) {
        ...
        System.arraycopy(_frame, _hopSize, _frame, 0, _frameSize - _hopSize);
